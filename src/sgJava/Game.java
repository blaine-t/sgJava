...
public class Game extends Lobby {
	...
	private static final double LEFT_MONEY_HEIGHT = 20;
	private static final double LEFT_MONEY_Y1 = 70;
	private static final double LEFT_MONEY_Y2 = LEFT_MONEY_Y1 + LEFT_MONEY_HEIGHT;
	...
	// Size of small UI fonts at 1080p
	private static final int LARGE_FONT_SIZE = 32;
	...
	public void drawGame() {
		...
		GLabel buyLabel = new GLabel("",0,0);

		// Declares the sell button
		GRect sellButton = new GRect(0,0,0,0);
		GLabel sellLabel = new GLabel("",0,0);
		...
		for (int i = 0; i < tickers.length; i++) {
			GLabel ticker = new GLabel(tickerList[i],0,0);
			tickers[i] = ticker;
			setupLabel(ticker);
		}
